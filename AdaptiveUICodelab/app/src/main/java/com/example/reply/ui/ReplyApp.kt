...
fun ReplyApp(replyHomeUIState: ReplyHomeUIState,
    ...
    // Todo 5 add dynamic navigation to the app
    /**
     * This will help us select type of navigation and content type depending on window size and
     * fold state of the device.
     */
    val navigationType: ReplyNavigationType
    // TODO 7 create a contentType that helps you decide whether to show just a list content, or show both a list and detail content dynamically on screen state changes.
    ...
    when (windowSize) {
        ...
        WindowWidthSizeClass.Medium -> {
            ...
            // TODO 8 detect if there is a crease or hinge available dividing a medium size foldable
...
private fun ReplyNavigationWrapperUI(
    ...
    // Todo 6 make the app react and change the type of navigation drawer whenever there is a configuration change
    if (navigationType == ReplyNavigationType.PERMANENT_NAVIGATION_DRAWER) {
        PermanentNavigationDrawer(
            ...
            ReplyAppContent(navigationType,
                contentType,
                replyHomeUIState)
        }
    } else {
...
fun ReplyAppContent(
    ...
    // TODO 7 use navigationType to decide the placement of the navigation rail or bottom navigation
    Row(modifier = Modifier.fillMaxSize()) {
        ...
        Column(modifier = Modifier
            ...
            // TODO 9 use the contentType to show content dynamically
...
// TODO 10 Summary
// You learned how to check a device's size and fold state, and update your app's UI, navigation,
// and other functions accordingly. You also learned how adding adaptability also provides enhancements
// in reachability and the user experience.

// The navigation and screen content dynamically changes in response to the device state changes.
// Made your app adaptable for all kinds of device states and sizes