    ...
    Surface(modifier = modifier.fillMaxSize(), color = Color.White, shape = BottomSheetShape) {
        Column(modifier = Modifier.padding(start = 24.dp, top = 20.dp, end = 24.dp)) {
            ...
            Box(Modifier.weight(1f)) {
                ...
                // The derivedStateOf calculation block is executed every time the internal state changes,
            // but the composable function only recomposes when the result of the calculation is different
            // from the last one. This minimizes the amount of times functions reading showButton recompose.
            }
        }
    }
}
