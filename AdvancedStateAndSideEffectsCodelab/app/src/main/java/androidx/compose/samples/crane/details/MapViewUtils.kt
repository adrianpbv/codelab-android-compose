...
fun rememberMapViewWithLifecycle(): MapView {
    ...
    // TODO 8.1: DisposableEffect step. Make MapView follow the lifecycle
    ...
    DisposableEffect(key1 = lifecycle, key2 = mapView) {
        ...
        // the observer will be removed whenever the current lifecycle changes or this composable leaves the Composition
        onDispose {
...
// TODO 8 create a LifecycleEventObserver to listen for lifecycle events and call the right methods on the MapView.
